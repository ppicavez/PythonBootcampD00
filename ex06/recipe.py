...
def delete_recipe(recipe_name: str):
    print(f" Are you sure to delete recipe : \"{recipe_name}\" (YES to delete).")
    security = input(" : ") 
    if security == "YES":
        try:
...
def principal():
    ...
    while True:
        ...
        if answer == "1":
            ...
            new_ingredients = input("Ingredients list (separated by , )\n").split(",")
            ...
            add_recipe(new_name, new_ingredients, new_meal, new_time)
        elif answer == "2":
